...
export default function WorkloadCover({ slug, title, alt }: WorkloadCoverProps) {
  const [failed, setFailed] = useState(false);
  const imageSrc = getWorkloadCoverImage(slug);
  const imageAlt = alt ?? `${title} — creative workstation`;
